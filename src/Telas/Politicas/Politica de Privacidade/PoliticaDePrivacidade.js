...
import Style from "../Politica de Privacidade/PoliticaDePrivacidade.module.css";
const PoliticaPrivacidade = () => {
  return (
    <div className={Style.DivGeralPoliticaPrivacidade}>
      <h4 className={Style.TextoPrivacidade}>
        A sua privacidade é importante para nós. É política do Horus Vocacional
        respeitar a sua privacidade em relação a qualquer informação sua que
        possamos coletar no site Horus Vocacional, e outros sites que possuímos
        e operamos. Solicitamos informações pessoais apenas quando realmente
        ...
        usuário e informações pessoais, entre em contacto connosco. Compromisso
        do Usuário O usuário se compromete a fazer uso adequado dos conteúdos e
        da informação que o Horus Vocacional oferece no site e com caráter
        ...
        propaganda ou conteúdo de natureza racista, xenofóbica, ou sobre
        cassinos, apostas online (ex.: Betway), jogos de sorte e azar, qualquer
        ...
        lógicos (softwares) do Horus Vocacional, de seus fornecedores ou
        ...
        danos anteriormente mencionados. Mais informações Esperemos que esteja
        ...
        nosso site. Esta política é efetiva a partir de Fevereiro/2021.
      </h4>
    </div>
  );
};
